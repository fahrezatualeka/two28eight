...
class ProductResource extends Resource
{
    ...
    // ✅ Ubah label "Products" menjadi "Daftar Produk"
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Repeater::make('sizes')
                ...
                ->visible(fn(Get $get) => $get('category') && !in_array($get('category'), ['trucker', 'accessories']))
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('stock')
                    ...
                    ->formatStateUsing(fn($state, $record) =>
                        in_array($record->category, ['trucker', 'accessories'])
            ...
            ->actions([
                // ✅ Ubah label "Edit" menjadi "Ubah"
                Tables\Actions\EditAction::make()->label('Ubah'),
                // ✅ Ubah label "Delete" menjadi "Hapus"
                Tables\Actions\DeleteAction::make()->label('Hapus'),
            ])
            // ✅ Tambahkan baris ini untuk menonaktifkan tautan pada seluruh baris tabel
            ->recordUrl(null);
    }
