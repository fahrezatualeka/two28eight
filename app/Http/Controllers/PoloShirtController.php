...
class PoloshirtController extends Controller
{
    ...
    {
        // Mulai query dengan memfilter langsung berdasarkan kolom 'category' dengan nilai 'poloshirt'
        $query = Product::where('category', 'poloshirt');
