...
<div class="bg-white min-h-screen px-6 py-10">
    <div class="container mx-auto pt-32 pb-10 bg-white">
        ...
        <h2 class="text-3xl font-bold mb-8">Twoeight - Accessories</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <aside class="bg-gray-50 p-5 rounded-lg border h-fit">
                ...
                <form id="filterFormTopi" action="{{ route('produk.accessories') }}" method="GET">
                    {{-- Input tersembunyi untuk kategori accessories, ini memastikan filter harga tetap di kategori yang benar --}}
            ...
            <main class="md:col-span-3">
                ...
                <div class="flex justify-end mb-4">
                    <form id="sortFormTopi" action="{{ route('produk.accessories') }}" method="GET">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    ...
                    @empty
                        <p class="col-span-full text-center text-gray-500">Tidak ada produk accessories yang ditemukan.</p>
                    @endforelse
                </div>
